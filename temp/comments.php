...
?>
                        ...
                        <aside <?php echo ((is_singular() ? 'id="comments"' : '') . (' class="sectioning comments"')); ?>>

                            <?php if ( have_comments() ) { ?>
                            
                                <h2 class="h loop-title comments-title"><?php 
                                    comments_number(); 
                                ?></h2>

                                <ol class="grouping xoxo comments"><?php
                                ...
                                <nav class="sectioning">
                                    <h3 class="h assistive"><?php _e('Comment navigation', 'theme'); ?></h3>
